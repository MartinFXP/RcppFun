...
#' @export
hcipp <- function(x, y, c) {
    .Call(`_RcppFun_hcipp`, x, y, c)
}
...
#' @export
whichExtreme <- function(m, type = 1L, extreme = 1L) {
    .Call(`_RcppFun_whichExtreme`, m, type, extreme)
}
